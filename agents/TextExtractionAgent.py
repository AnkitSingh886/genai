...
class TextExtractionAgent:
    ...
    def __init__(self, file_path="../data/srd.docx", output_json="../data/extracted_data.json"):
...
#     def __init__(self, file_path="../data/srd.docx", output_path="../data/extracted_data.json"):
